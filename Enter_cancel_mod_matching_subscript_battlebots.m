...
%         test_robot_inventory_changes_aggressive=(transaction_price_volume_stor_mat_prev_order(:,7)==77).*transaction_price_volume_stor_mat_prev_order(:,2).*transaction_price_volume_stor_mat_prev_order(:,4);
%         test_robot_inventory_changes_passive=(transaction_price_volume_stor_mat_prev_order(:,6)==77).*transaction_price_volume_stor_mat_prev_order(:,2).*transaction_price_volume_stor_mat_prev_order(:,4)*(-1);
%         smart_robot_cum_net_inventory(number_of_smart_robots+1)=smart_robot_cum_net_inventory(number_of_smart_robots+1)+sum(test_robot_inventory_changes_aggressive)+sum(test_robot_inventory_changes_passive);
    end
